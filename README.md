...
Этот проект лишь прототип. В случае нахождения багов или возможности как либо исправить проект, можно отослать мне вами изменённый код для последующего коммита новой версии. Использование в личных целях даже без указания авторства разрешается, но не одобряется присваивание работы себе. Если хотите использовать для своих проектов или полностью сп***ить проект, то просто видоизмените его под свой лад))
